...
// https://github.com/songziming/wheel/blob/master/kernel/misc/vsprintf.c
...
static char * fmt_string(char * buf, char * end, char * str, _u32 flags, int width, int precision) {
    int slen = strlen(str);
...
static char * fmt_number(char * buf, char * end, _u64 num, int base, _u32 flags, int width, int precision) {
